...
import com.emt.pdgo.next.ui.dialog.AndroidLoadingDialog;
...
public class GlobalDialogManager {
     ...
     * 展示加载框
     */
    public synchronized void show(FragmentManager manager,String hintMsg) {
        if (manager != null && mLoadingDialog != null && !mIsShow) {
            mLoadingDialog.setHintMsg(hintMsg);
            mLoadingDialog.showAllowingStateLoss(manager, "loadingDialog");
            mIsShow = true;
        }
    }
