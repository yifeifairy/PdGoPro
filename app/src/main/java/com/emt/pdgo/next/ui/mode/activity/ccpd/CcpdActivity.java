package com.emt.pdgo.next.ui.mode.activity.ccpd;
...
public class CcpdActivity extends BaseActivity {
    ...
    public void initAllViews() {
        setContentView(R.layout.activity_ccpd);
    ...
    public void registerEvents() {
        ...
        btnNext.setOnClickListener(v -> {
            CacheUtils.getInstance().getACache().put(PdGoConstConfig.CCPD_BEAN, entity);
            new Thread(() -> {
...
//                            Log.e("处方设置","处方设置--"+hisRx.ulTreatTime);
                EmtDataBase
                        .getInstance(CcpdActivity.this)
                        .getRxDao()
                        .insertRx(hisRx);
            });
            MyApplication.apdMode = 3;
            doGoTOActivity(PreHeatActivity.class);
        });
        btn_submit.setOnClickListener(v -> {
            doGoTOActivity(ApdParamSetActivity.class);
        });
        entity = PdproHelper.getInstance().ccpdBean();
