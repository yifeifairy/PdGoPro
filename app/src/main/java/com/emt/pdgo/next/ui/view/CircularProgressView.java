 ...
 * @Description:    圆形进度条控件
 * @Author:         chenjh
 * @CreateDate:     2020/1/3 11:48 AM
 * @UpdateUser:     更新者
 * @UpdateDate:     2020/1/3 11:48 AM
 * @UpdateRemark:   更新内容
 * @Version:        1.0
 */
public class CircularProgressView extends View {
    ...
    public CircularProgressView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        int finishColor = typedArray.getColor(R.styleable.CircularProgressView_progFinishColor, -1);
        if (startColor != -1 && finishColor != -1) mColorArray = new int[]{startColor, finishColor};
