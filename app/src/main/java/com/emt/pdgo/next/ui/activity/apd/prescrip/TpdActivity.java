...
public class TpdActivity extends BaseActivity {
    ...
    public void initViewData() {
        entity = PdproHelper.getInstance().tpdBean();
...
//                            setTotal();
                            MyApplication.FIRST_VOL = Integer.parseInt(result);
                            setCycleNum();
                            break;
