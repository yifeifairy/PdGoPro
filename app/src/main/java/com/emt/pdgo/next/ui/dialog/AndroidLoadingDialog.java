...
public class AndroidLoadingDialog extends DialogFragment implements DialogInterface.OnKeyListener {
    ...
    private String TAG = "AndroidLoadingDialog";
...
//        if(mContext!=null){
//            DisplayMetrics dm = getDialog().getContext().getResources().getDisplayMetrics();
//            int height = dm.heightPixels;
//            int width = dm.widthPixels;
//            int sw = getDialog().getContext().getResources().getConfiguration().smallestScreenWidthDp;
