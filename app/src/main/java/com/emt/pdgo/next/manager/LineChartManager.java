package com.emt.pdgo.next.manager;

import android.content.Context;
import android.graphics.Color;
import android.graphics.drawable.Drawable;

import com.emt.pdgo.next.data.chart.CompositeIndexBean;
import com.emt.pdgo.next.data.chart.IncomeBean;
import com.emt.pdgo.next.ui.view.CustomLineChartMarkView;
 ...
 * @Description: 折线图管理
 * @Author: chenjh
 * @CreateDate: 2019/12/18 4:28 PM
 * @UpdateUser: 更新者
 * @UpdateDate: 2019/12/18 4:28 PM
 * @UpdateRemark: 更新内容
 * @Version: 1.0
 */
...
//        lineChart.getViewPortHandler().setMaxOffsetLeft(150);
...
//        leftYAxis.enableGridDashedLine(10f, 10f, 0f);
        ...
        rightYAxis.setAxisMaximum(3000);
...
//        lineDataSet.setHighLightColor(0xffff2d55);//设置点击交点后显示交高亮线的颜色
        lineDataSet.setHighLightColor(Color.TRANSPARENT);//设置点击交点后显示交高亮线的颜色
    ...
    public void showMultiNormalLineChart(List<List<Float>> yDataList, List<String> lineNames, List<Integer> colors) {
        ...
        for (int i = 0; i < yDataList.size(); i++) {
            ...
            initLineDataSet(lineDataSet, colors.get(i), LineDataSet.Mode.LINEAR);
...
//        LineChartMarkView mv = new LineChartMarkView(context, xAxis.getValueFormatter());
        CustomLineChartMarkView mv = new CustomLineChartMarkView(context, xAxis.getValueFormatter(),lineChart.getMinOffset());
