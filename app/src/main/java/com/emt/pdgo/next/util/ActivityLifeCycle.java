...
public class ActivityLifeCycle implements Application.ActivityLifecycleCallbacks {
    ...
    public void onActivityCreated(Activity activity, Bundle bundle) {
        Log.e("onActivityCreated" , getActivityName(activity));
    }

    @Override
    public void onActivityStarted(Activity activity) {
        Log.e("onActivityStarted " , getActivityName(activity) + " " + foregroundActivityCount);
    ...
    public void onActivityResumed(Activity activity) {
        Log.e("onActivityResumed" , getActivityName(activity));
        ...
        if (willSwitchToForeground && isInteractive(activity)) {
            ...
            Log.e( "onActivityResumed","switch to foreground");
        }
        if (isForegroundNow) {
    ...
    public void onActivityPaused(Activity activity) {
        Log.e("onActivityPaused" , getActivityName(activity));
    ...
    public void onActivityStopped(Activity activity) {
        Log.e("onActivityStopped" , getActivityName(activity));
        addAppUseReduceTimeIfNeeded(activity);
        ...
        if (foregroundActivityCount == 0) {
            ...
            Log.e("switch to background"," (reduce time[" + appUseReduceTime + "])");
    ...
    public void onActivitySaveInstanceState(Activity activity, Bundle bundle) {
        Log.e("saveInstanceState" , getActivityName(activity));
    }

    @Override
    public void onActivityDestroyed(Activity activity) {
        Log.e("onActivityDestroyed" , getActivityName(activity));
    }
...
//        Log.e("保存今日运行时间", "时间"+time);
//        Log.e("保存今日运行时间", "today时间"+getTodayStartTime());
//        Log.e("保存今日运行时间", "total时间"+(getTodayStartTime()+time));
    }
}
