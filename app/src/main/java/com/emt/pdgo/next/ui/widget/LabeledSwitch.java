package com.emt.pdgo.next.ui.widget;/*
...
public class LabeledSwitch extends ToggleableView {
    ...
    private void initView() {
        ...
        this.colorDisabled = Color.parseColor("#0089ff");
    }
    ...
    private void initProperties(AttributeSet attrs) {
        ...
        for (int i = 0; i < N; ++i) {
            ...
            if (attr == R.styleable.Toggle_on) {
                ...
                colorDisabled = tarr.getColor(R.styleable.Toggle_colorOff, Color.parseColor("#0089ff"));
...
//                            switchColor.addUpdateListener(animaValueAnimator.AnimatorUpdateListenertion -> {
//                                float value = (float) animation.getAnimatedValue();
//                                thumbBounds.set(value, thumbBounds.top, value + thumbRadii, thumbBounds.bottom);
//                                invalidate();
//                            });
